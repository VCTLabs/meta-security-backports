...
SRC_URI = "https://github.com/ComplianceAsCode/content/releases/download/v0.1.75/${BPN}-${PV}.tar.bz2 \
           file://oe-add-platform_package_overrides.patch \
           file://run_eval.sh \
           "

SRC_URI[sha256sum] = "44f310f02db0d6fe5328f589a384ccab190e8b7829c92e286b6cb16cccfa4c56"
